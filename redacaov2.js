(function() {
    ...
    async function mainProcess() {
        ...
        const initialPrompt = `**PROMPT OTIMIZADO V4 (FOCO NATURALIDADE E TÍTULO)**\n\n**Objetivo:** Gerar um texto dissertativo-argumentativo coeso, com linguagem **extremamente natural** (evitando jargões de IA), bem estruturado, dentro dos limites de caracteres e com um **título conciso e informativo**.\n\n**Contexto da Tarefa:**\n${JSON.stringify(ctx, null, 1)}\n\n**Instruções Detalhadas:**\n1.  **TÍTULO:** Crie um título **muito curto (3-6 palavras)** que capture a **essência do argumento principal** do texto. Deve ser **direto, claro e relacionado ao CONTEÚDO** da redação, não apenas ao tema geral. Evite títulos genéricos.\n2.  **TEXTO (1700-3000 caracteres):**\n    *   **Estrutura:** Mantenha a estrutura dissertativa padrão (introdução, desenvolvimento, conclusão).\n    *   **Linguagem Natural (CRÍTICO):**\n        *   **Vocabulário:** Use vocabulário preciso, mas comum no português cotidiano culto. **EVITE PALAVRAS "CARAS" DE IA** como 'outrossim', 'mormente', 'hodiernamente', 'precipuamente', 'salientar', 'é mister', 'é imperativo', 'sob essa ótica', 'nesse ínterim'. Prefira sinônimos mais naturais.\n        *   **Fluidez e Ritmo:** Varie o tamanho das frases (mescle curtas e médias). Use conectivos comuns (mas, porém, contudo, então, assim, por isso, além disso, no entanto, pois, etc.) para ligar ideias de forma **suave e lógica**, sem excessos.\n        *   **Inícios de Parágrafo/Frase:** **CRUCIAL DIVERSIFICAR.** Não inicie parágrafos repetidamente com conectivos. Use retomadas, afirmações, contextualizações breves. Evite começar muitas frases com "É importante...", "Além disso...", "No entanto...".\n        *   **Pontuação:** Use vírgulas e pontos de forma correta e que ajude na leitura natural. Evite padrões muito previsíveis.\n    *   **Argumentação:** Construa argumentos lógicos baseados no contexto, mas com suas próprias palavras, como um estudante faria.\n\n**Modelo de Resposta OBRIGATÓRIO (SEM NADA EXTRA):**\nTITULO: [Título Curto e Direto ao Ponto]\n\nTEXTO:\n[Introdução Clara e Concisa]\n\n[Desenvolvimento Fluido 1]\n\n[Desenvolvimento Fluido 2]\n\n[Desenvolvimento Fluido 3 (se aplicável)]\n\n[Conclusão Natural]\n\n**Foco Final:** A prioridade máxima é que o texto **não pareça ter sido escrito por IA**. Deve soar como um bom aluno: organizado, claro, com linguagem correta, mas absolutamente natural na escolha de palavras, pontuação e fluxo. O título deve refletir o cerne da discussão de forma concisa. Respeite o limite de caracteres.`;
        ...
        const humanPrompt = `**Tarefa:** Refinar o texto abaixo para MÁXIMA naturalidade, eliminando QUALQUER vestígio de escrita artificial. Manter 100% do sentido, argumentos e estrutura de parágrafos.\n**Ações de Refinamento:**\n*   **Vocabulário:** Troque palavras formais/rebuscadas demais (se ainda houver) por sinônimos comuns e naturais.\n*   **Fluidez:** Melhore conexões entre frases/parágrafos com conectivos variados e NADA repetitivos. Ajuste ritmo se necessário.\n*   **Inícios:** Confira e varie inícios de frases/parágrafos para não soar mecânico.\n*   **Pontuação:** Verifique a naturalidade da pontuação.\n*   **Retorno:** APENAS o texto refinado.\n\n**Texto Original:**\n${text}`;
