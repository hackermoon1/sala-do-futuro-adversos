(function() {
    ...
    async function mainProcess() {
        ...
        const initialPrompt = `**PROMPT OTIMIZADO V2: REDAÇÃO DISSERTATIVA NATURAL (CARACTERES ESPECÍFICOS)**\n\n**Objetivo Final:**\nProduzir uma redação dissertativa coesa, fluida e com aparência natural, demonstrando:\n- Domínio da estrutura dissertativa (introdução, desenvolvimento, conclusão).\n- Raciocínio lógico consistente.\n- Linguagem adequada ao gênero, mas com fluidez humana.\n- Conhecimento geral sobre o tema (sem profundidade excessiva).\n\n**Contexto da Tarefa:**\n${JSON.stringify(ctx, null, 1)}\n\n**Parâmetros Estruturais:**\n1.  **TÍTULO:**\n    -   Curto e chamativo (máximo 8 palavras).\n    -   Deve resumir a ideia central ou despertar interesse.\n2.  **INTRODUÇÃO:**\n    -   Contextualizar o tema brevemente.\n    -   Apresentar a tese/ideia principal de forma clara.\n3.  **DESENVOLVIMENTO:**\n    -   Argumentar de forma progressiva e lógica, usando o contexto como base.\n    -   Conectar as ideias entre os parágrafos (usar conectivos apropriados).\n    -   Fundamentar com raciocínios plausíveis (sem dados específicos).\n4.  **CONCLUSÃO:**\n    -   Retomar a ideia principal (sem repetir palavras exatas).\n    -   Apresentar uma reflexão final ou proposta concisa, se aplicável.\n\n**Restrições de Tamanho:**\n❗ **IMPORTANTE:** O **TEXTO** final (excluindo o "TITULO:") deve ter **entre 1700 e 3000 caracteres** no total.\n\n**Estilo de Escrita (FAZER SOAR HUMANO):**\n❗ **Evitar:**\n    -   Citações diretas, dados estatísticos precisos.\n    -   Termos excessivamente técnicos ou jargão.\n    -   Estruturas de frase muito repetitivas ou rígidas.\n    -   Linguagem que soe como tradução ou excessivamente formal/robótica.\n    -   Começos de frase muito clichês (Ex: "Hodiernamente...", "É notório que...").\n✅ **Priorizar:**\n    -   **Naturalidade:** Linguagem clara, vocabulário bom, mas comum para um estudante.\n    -   **Fluidez:** Frases com tamanhos variados (curtas e longas). Use conectivos comuns (mas, então, por isso, além disso, no entanto, etc.) para ligar ideias suavemente.\n    -   **Pontuação:** Use vírgulas, pontos, etc., de forma correta e natural, sem excessos ou padrões muito artificiais.\n    -   **Coerência:** Argumentos lógicos e bem conectados.\n\n**Modelo de Resposta OBRIGATÓRIO (SEM NADA EXTRA):**\nTITULO: [Título curto e chamativo]\n\nTEXTO:\n[Introdução concisa]\n\n[Desenvolvimento - vários parágrafos conectados]\n\n[Conclusão]\n\n**Dica Final:** Pense como um bom aluno escreveria: organizado, com boas ideias, mas com um fluxo e vocabulário naturais, não como uma máquina. Garanta que o texto atinja o mínimo de caracteres solicitado.`;
